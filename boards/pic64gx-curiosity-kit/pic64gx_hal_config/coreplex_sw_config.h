 ...
 * state machine
 */
#define BSP_SETTING_CONTEXT_A_HART_EN    0x0000000EUL    /* harts 1 to 3 */
#define BSP_SETTING_CONTEXT_B_HART_EN    0x00000010UL    /* hart 4 */
...
#  undef BSP_SETTING_SWITCH_ADDRESS
#  define BSP_SETTING_SWITCH_ADDRESS CONFIG_SERVICE_MMC_MMC_SD_EMMC_DEMUX_SELECT_ADDRESS
#else
#  ifndef BSP_SETTING_SWITCH_ADDRESS
#    define BSP_SETTING_SWITCH_ADDRESS 0x4fffff00
#  endif
#endif
